...
class Ui_CompetencesView(object):
    def setupUi(self, CompetencesView):
        ...
        self.lb_title = QtWidgets.QLabel(CompetencesView)
        self.lb_title.setGeometry(QtCore.QRect(40, 30, 731, 41))
        font = QtGui.QFont()
        ...
        self.lb_place_error.setGeometry(QtCore.QRect(380, 160, 191, 20))
        ...
        self.ed_date.setGeometry(QtCore.QRect(130, 220, 191, 31))
        self.ed_date.setObjectName("ed_date")
        self.lb_date_error = QtWidgets.QLabel(CompetencesView)
        self.lb_date_error.setGeometry(QtCore.QRect(60, 250, 351, 20))
        ...
        self.label_4.setGeometry(QtCore.QRect(200, 180, 81, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_4.setFont(font)
        self.label_4.setObjectName("label_4")
        self.label_5 = QtWidgets.QLabel(CompetencesView)
        self.label_5.setGeometry(QtCore.QRect(450, 180, 81, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_5.setFont(font)
        self.label_5.setObjectName("label_5")
        self.ed_time = QtWidgets.QLineEdit(CompetencesView)
        self.ed_time.setGeometry(QtCore.QRect(380, 220, 191, 31))
        self.ed_time.setObjectName("ed_time")
        self.lb_time_error = QtWidgets.QLabel(CompetencesView)
        self.lb_time_error.setGeometry(QtCore.QRect(380, 250, 191, 20))
        ...
        self.btn_create_competition.setGeometry(QtCore.QRect(260, 280, 171, 41))
        ...
        self.lb_subtitle = QtWidgets.QLabel(CompetencesView)
        self.lb_subtitle.setGeometry(QtCore.QRect(800, 100, 461, 41))
        font = QtGui.QFont()
        font.setFamily("MS Sans Serif")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.groups_table.setGeometry(QtCore.QRect(790, 340, 481, 311))
        ...
        self.btn_see_all_groups.setGeometry(QtCore.QRect(800, 300, 93, 28))
    ...
    def retranslateUi(self, CompetencesView):
        ...
        self.lb_title.setText(_translate("CompetencesView", "CONFIGURAR COMPETENCIAS"))
        ...
        self.lb_subtitle.setText(_translate("CompetencesView", "GRUPOS/OLEADAS"))
