...
class Ui_CompetencesView(object):
    def setupUi(self, CompetencesView):
        ...
        self.label_7.setGeometry(QtCore.QRect(1150, 130, 311, 41))
        font = QtGui.QFont()
        font.setFamily("MS Sans Serif")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.lb_competence_selected.setGeometry(QtCore.QRect(1140, 190, 331, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_8.setGeometry(QtCore.QRect(1180, 240, 81, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_8.setFont(font)
        self.label_8.setObjectName("label_8")
        self.lb_group_name_error = QtWidgets.QLabel(CompetencesView)
        self.lb_group_name_error.setGeometry(QtCore.QRect(1110, 310, 191, 20))
        ...
        self.label_9.setGeometry(QtCore.QRect(1380, 240, 81, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_9.setFont(font)
        self.label_9.setObjectName("label_9")
        self.groups_table = QtWidgets.QTableWidget(CompetencesView)
        self.groups_table.setGeometry(QtCore.QRect(1110, 370, 351, 391))
        ...
        self.btn_create_group.setGeometry(QtCore.QRect(1340, 330, 101, 28))
        self.btn_create_group.setObjectName("btn_create_group")
        self.btn_see_all_groups = QtWidgets.QPushButton(CompetencesView)
        self.btn_see_all_groups.setGeometry(QtCore.QRect(1120, 330, 93, 28))
    ...
    def retranslateUi(self, CompetencesView):
        ...
        self.lb_competence_selected.setText(_translate("CompetencesView", "COMPETENCIA:"))
