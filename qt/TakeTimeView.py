...
class Ui_TakeTime(object):
    def setupUi(self, TakeTime):
        ...
        font = QtGui.QFont()
        font.setPointSize(8)
        self.table_times.setFont(font)
        self.table_times.setObjectName("table_times")
        self.table_times.setColumnCount(11)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.table_times.setHorizontalHeaderItem(8, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_times.setHorizontalHeaderItem(9, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_times.setHorizontalHeaderItem(10, item)
...
"color:white;")
    ...
    def retranslateUi(self, TakeTime):
        ...
        item = self.table_times.horizontalHeaderItem(8)
        item.setText(_translate("TakeTime", "Manillas"))
        item = self.table_times.horizontalHeaderItem(9)
        item.setText(_translate("TakeTime", "Amonestacion"))
        item = self.table_times.horizontalHeaderItem(10)
        item.setText(_translate("TakeTime", "Estado"))
        ...
        self.cb_order_table.setItemText(5, _translate("TakeTime", "Tanda ascendente"))
        self.cb_order_table.setItemText(6, _translate("TakeTime", "Tanda descendente"))
        ...
        self.label_6.setText(_translate("TakeTime", "Filtrar por tanda/oleada/nombre/categoria"))
