...
class CompetenceController:
    ...
    def built_style(self):
        ...
        self.window.lb_group_name_error.setStyleSheet(ColorPicker.ERROR_COLOR)
        self.window.lb_group_order_error.setStyleSheet(ColorPicker.ERROR_COLOR)
        self.window.lb_competence_selected.setStyleSheet(ColorPicker.LABEL_COLOR)
        ...
        self.window.lb_place_error.setStyleSheet(ColorPicker.ERROR_COLOR)
        self.window.lb_date_error.setStyleSheet(ColorPicker.ERROR_COLOR)
        self.window.lb_time_error.setStyleSheet(ColorPicker.ERROR_COLOR)

        self.window.groups_table.setStyleSheet(ColorPicker.FONT_COLOR)
        self.window.ed_group_name.setStyleSheet(ColorPicker.FONT_COLOR)
        self.window.ed_group_order.setStyleSheet(ColorPicker.FONT_COLOR)
