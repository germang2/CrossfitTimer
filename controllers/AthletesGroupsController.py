...
class AthletesGroupsController:
    ...
    def built_style(self):
        ...
        self.window.lb_alert.setStyleSheet(ColorPicker.ERROR_COLOR)
        self.window.lb_error_add_athlete.setStyleSheet(ColorPicker.ERROR_COLOR)
        ...
        self.window.lb_group_name.setStyleSheet(ColorPicker.LABEL_COLOR)
        self.window.lb_group_name_2.setStyleSheet(ColorPicker.LABEL_COLOR)
        ...
        self.window.ed_filter_athlete.setStyleSheet(ColorPicker.LABEL_COLOR)
