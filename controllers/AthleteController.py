...
class AthletesController:
    def __init__(self, window: AthletesWindow):
        ...
        self.clear_table()
        self.built_style()
        self.window.ed_name.setFocus()

    def built_style(self):
        self.window.setStyleSheet(ColorPicker.BACKGROUND_GRADIENT_COLOR)
        self.window.label.setStyleSheet(ColorPicker.LABEL_COLOR)
        self.window.label_2.setStyleSheet(ColorPicker.LABEL_COLOR)
        self.window.label_3.setStyleSheet(ColorPicker.LABEL_COLOR)
        self.window.label_4.setStyleSheet(ColorPicker.LABEL_COLOR)
        self.window.label_5.setStyleSheet(ColorPicker.LABEL_COLOR)
        self.window.label_6.setStyleSheet(ColorPicker.LABEL_COLOR)
        self.window.label_7.setStyleSheet(ColorPicker.LABEL_COLOR)
        self.window.label_8.setStyleSheet(ColorPicker.LABEL_COLOR)
        self.window.label_9.setStyleSheet(ColorPicker.LABEL_COLOR)
        self.window.ed_name.setStyleSheet(ColorPicker.LABEL_COLOR)
        self.window.ed_lastname.setStyleSheet(ColorPicker.LABEL_COLOR)
        self.window.ed_age.setStyleSheet(ColorPicker.LABEL_COLOR)
        self.window.ed_nit.setStyleSheet(ColorPicker.LABEL_COLOR)
        self.window.ed_club.setStyleSheet(ColorPicker.LABEL_COLOR)
        self.window.ed_filter.setStyleSheet(ColorPicker.LABEL_COLOR)
        ...
        self.window.lb_name_error.setStyleSheet(ColorPicker.ERROR_COLOR)
        self.window.lb_age_error.setStyleSheet(ColorPicker.ERROR_COLOR)
        self.window.lb_nit_error.setStyleSheet(ColorPicker.ERROR_COLOR)
        self.window.lb_club_error.setStyleSheet(ColorPicker.ERROR_COLOR)
        self.window.lb_lastname_error.setStyleSheet(ColorPicker.ERROR_COLOR)
        self.window.lb_error_delete.setStyleSheet(ColorPicker.ERROR_COLOR)
